...
TRANSLATIONS = translations/celladoor_pt_BR.ts translations/celladoor_it_IT.ts translations/celladoor_de_DE.ts translations/celladoor_fr_FR.ts
...
symbian: {
    ...
    addFiles.sources = translations/celladoor_pt_BR.qm translations/celladoor_it_IT.qm translations/celladoor_de_DE.qm translations/celladoor_fr_FR.qm
    addFiles.path = .
    DEPLOYMENT += addFiles
}
...
i18n.files = $${SOURCE_TREE}/celladoor_pt_BR.qm $${SOURCE_TREE}/celladoor_it_IT.qm $${SOURCE_TREE}/celladoor_de_DE.qm $${SOURCE_TREE}/celladoor_fr_FR.qm
